...
export default class CubeRenderSystem
{
    ...
    constructor(gl: any) {
        ...
        this._cubeProgramInfo = twgl.createProgramInfo(gl, [positionNormalVert, diffuseSpecularFrag]);
        this._wireframeProgramInfo = twgl.createProgramInfo(gl, [positionVert, flatFrag]);
    ...
    render(gl: any, alpha: number): void {
        ...
        for (const pair of this._cubes) {
            ...
            twgl.setBuffersAndAttributes(gl,this._cubeProgramInfo,this._cubeBufferInfo);
            ...
            twgl.setBuffersAndAttributes(gl,this._wireframeProgramInfo,this._wireBufferInfo);
