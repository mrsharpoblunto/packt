...
export default class InputHandler {
    ...
    constructor(canvas: any) {
        ...
        canvas.addEventListener('mousedown',this._handleMouseDown, { passive: true });
        canvas.addEventListener('mouseup',this._handleMouseUp, { passive: true });
        canvas.addEventListener('mousemove',this._handleMouseMove, { passive: true });
        ...
        window.addEventListener('keypress',this._handleKeyPress, { passive: true });
    }
