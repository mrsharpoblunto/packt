...
export class Entity {
    ...
    hasComponents<C: Object>(componentClasses: C,fn: ?(instances: {[key: $Enum<C>]: Object}) => any): boolean {
        let instances = null;
        for (const c in componentClasses) {
            const componentInstance = this._components.get(componentClasses[c]);
