...
function transform(src, options) {
  ...
  return {
    code: babelTransform(src, {
      plugins: [[scopifyAndProcess, opts]],
    }).code,
    opts,
  };
}
...
new _$_foobar();`,
  ...
  it('Rewrites named exports', () => {
    const result = transform('export { foo, bar }');
...
_$_exports.bar = _$_bar; /*</__packt_symbol__bar>*/`,
  ...
  it('Rewrites named aliased exports', () => {
    const result = transform('export { foo as bar }');
...
/*<__packt_symbol__default>*/_$_exports.default = _$_foo; /*</__packt_symbol__default>*/`,
  ...
  it('Rewrites default function exports', () => {
    const result = transform('export default function() {}');
...
_$_exports.default = _$_; /*</__packt_symbol__default>*/`,
  ...
  it('Rewrites default named function exports', () => {
    const result = transform('export default function foo() {}');
...
_$_exports.default = _$_foo; /*</__packt_symbol__default>*/`,
  ...
  it('Rewrites default named class exports', () => {
    const result = transform('export default class foo {}');
...
_$_exports.default = _$_foo; /*</__packt_symbol__default>*/`,
  ...
  it('Rewrites wildcard exports imported from another module', () => {
    const result = transform('export * from "module";');
...
Object.assign(_$_exports, __packt_import__("_$_exports", "module"));`,
    ...
    expect(result.opts.delegate.importsModule.mock.calls[0][0]).toEqual([
      'default',
    ]);
  ...
  it('Rewrites named exports imported from another module', () => {
    const result = transform('export {foo, bar as baz} from "module";');
...
function _$_bar() {
  ...
  _$_x();
    ...
    expect(result.opts.delegate.importsModule.mock.calls[1][0]).toEqual([
      'default',
    ]);
...
function _$_bar() {
  ...
  it('Emits warnings for requires with unresolvable expressions', () => {
    const result = transform(`const x = require("bar" + baz);`);
    ...
    expect(result.opts.delegate.emitWarning.mock.calls[0][0]).toEqual([
      'default',
    ]);
...
class _$_foo {
  ...
  it('anonymous import is a noop', () => {
    const result = transform(`import 'module'`);
